...
entrar "como una persona" desde tu máquina, y saber **cuándo** no se puede y hay
...
**Caso real (portal Adevinta con DataDome):** la IPv4 era residencial limpia, pero
Chromium salía por una **IPv6** que DataDome trataba como VPN/datacenter → bloqueo con
"Estás usando una VPN". La home y la sección general cargaban; solo el **listado
filtrado profundo** se bloqueaba. Muchos operadores domésticos asignan rangos IPv6 que
los anti-bot marcan aunque tu IPv4 sea limpia: por eso el forzado de IPv4 (abajo) suele
desatascarlo.
...
Reporta con honestidad: "entré como humano hasta donde el anti-bot lo permite;
